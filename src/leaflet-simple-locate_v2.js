/*
 * Leaflet.SimpleLocate v2.0.0-alpha.1 - 2026-02-28
 *
...
<svg width="96" height="96" viewBox="-48 -48 96 96" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
    ...
    _updateMarker: function () {
        ...
        if (this._circle) {
            ...
            this._circle = new L.Circle([this._latitude, this._longitude], {
        ...
        if (this._marker && this._marker.icon_name === icon_name)
            ...
            this._marker = new L.Marker([this._latitude, this._longitude], {
